"""Reference "Melon Maxxer" agent from the competition's official tutorial
notebook (bovard/kaggriculture-getting-started), copied verbatim. A weak,
naive single-farmer single-crop MELON bot -- kept here so we can measure how
our agent performs under REAL shared-market competition for MELON, since our
other local test opponents (pass/random/starter) don't compete for any crop
we actually grow (starter only ever plants 1 tile of CARROT)."""
